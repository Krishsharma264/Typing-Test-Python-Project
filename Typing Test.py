...
Mainscreen.title('Typing Test By [The Tinkerers]') #Tinkerers is the team name.
...
def movingtext():
    ...
    floatingtext='Typing Test By [The Tinkerers]'
...
def giventime():
    ...
    if time>0:
        ...
        gameinstruction.configure(text='Correct = {} | Wrong = {} | Total Score = {}'.format(score,missed,score-missed))
...
scorelabelcount.place(x=110,y=150)
...
timercount.place(x=660,y=150)



gameinstruction= Label(Mainscreen,text='Hit enter button after typing the word',font=('arial',25,'italic bold'),fg='red')
gameinstruction.place(x=140,y=500)
